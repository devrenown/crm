        ...
        <div class="container-fluid text-md-left">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-xl-3 mx-auto mt-3">
                    <img src="<?php echo e(asset('images/front/logo-white.png')); ?>" alt="RenownCRM Logo" style="height:50px;"
                        class="mb-3">
                    <p>
                ...
                <div class="col-md-2 col-6 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p><a href="<?php echo e(url('/#features')); ?>" class="text-white text-decoration-none">Features</a></p>
                    <!-- <p><a href="#pricing" class="text-white text-decoration-none">Pricing</a></p> -->
                    <p><a href="<?php echo e(url('/#how-it-works')); ?>" class="text-white text-decoration-none">How it Works</a></p>
                    <p><a href="<?php echo e(url('/#testimonials')); ?>" class="text-white text-decoration-none">Testimonials</a></p>
                    <p><a href="<?php echo e(url('/#contact')); ?>" class="text-white text-decoration-none">Contact</a></p>
                </div>
                ...
                <div class="col-md-3 col-6 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p><a href="<?php echo e(route('privacy-policy')); ?>" class="text-white text-decoration-none">Privacy Policy</a></p>
                    <p><a href="<?php echo e(route('terms-conditions')); ?>" class="text-white text-decoration-none">Terms & Conditions</a></p>
                    <p><a href="<?php echo e(url('/#faq')); ?>" class="text-white text-decoration-none">FAQ</a></p>
                </div>
    ...
    </footer><?php /**PATH /home/renown/public_html/dev.renownsystem.com/resources/views/pages/front/layouts/footer.blade.php ENDPATH**/ ?>