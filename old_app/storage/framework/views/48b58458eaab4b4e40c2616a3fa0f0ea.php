<!-- Modal -->
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo e(route('save.demo-request')); ?>" id="demo-form" method="post">
              <?php echo csrf_field(); ?>
    ...
    </div><?php /**PATH /home/renown/public_html/dev.renownsystem.com/resources/views/pages/front/blocks/demo-modal.blade.php ENDPATH**/ ?>