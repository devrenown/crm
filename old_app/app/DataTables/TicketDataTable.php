    ...
    public function dataTable($query)
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('priority', function($row){
                ...
                $priority = strtolower($row->priority->name);

                $colorClass = match($priority) {
                    'low'       => 'badge bg-inverse-success',
                    'medium'    => 'badge bg-inverse-warning',
                    'high'      => 'badge bg-inverse-danger',
                    default     => 'badge bg-inverse-secondary',
                };

                return '<span class="'.$colorClass.'">'.ucfirst($priority).'</span>';
            })
            ...
            ->rawColumns(['action', 'priority', 'user','tk_id']);
