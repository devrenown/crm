...
class BudgetCategoriesController extends Controller
{
     ...
     */
    public function edit(BudgetCategory $budget_category)
    {
        return view('accounting::categories.edit', ['category' => $budget_category]);
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(Request $request, BudgetCategory $budget_category)
    {
        $request->validate([
            'name' => 'required',
        ]);
     ...
     */
    public function destroy(BudgetCategory $budget_category)
    {
