...
@section('page-content')
    <div class="content container-fluid">
        ...
        <!-- Page Header -->
        <x-breadcrumb>
            <x-slot name="title">{{ __('Edit Estimate') }}
            <button onclick="window.history.back()" class="btn btn-sm btn-primary float-end">Back</button>
            </x-slot>
                ...
                <form action="{{ route('estimates.update', $estimate->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @method("PUT")
                        ...
                        <div x-data="{
                            ...
                            setTax(percent) {
                                this.taxPercentage = parseFloat(percent) || 0;
                            },

                            get discountAmount() {
                                return (this.subtotalVal * (this.discount / 100)).toFixed(2);
                            },
                            get taxAmount() {
                                return ((this.subtotalVal * this.taxPercentage ) / 100 ).toFixed(2);
                            },
                            get grandTotal() {
                                return (parseFloat(this.subtotalVal) - parseFloat(this.discountAmount) + parseFloat(this.taxAmount)).toFixed(2);
                            },
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end pe-4">
                                                    <input class="form-control text-end" :value="taxAmount" name="taxes_sum" id="taxes_sum" readonly type="text">
                                                </td>
                                            </tr>
                                            <tr>
