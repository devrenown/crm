...
class EmployeeTaskListDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return (new EloquentDataTable($query))
            ...
            //         $id     = $row->id;
            //         $emp_id = $row->user_id;
            //         return view('pages.tasks.action',compact('id', 'emp_id'));
            // })
    ...
    {
        $empId = $this->empId;
        return WorkReport::where('user_id', $empId)->orderBy('created_at', 'desc')->newQuery();
    }
