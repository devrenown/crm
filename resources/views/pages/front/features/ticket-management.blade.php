            ...
            <div class="row mt-5">
                <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <h1 class="breadcrump-heading display-5 display-md-4 display-lg-3 fw-bold">
                        TICKET <br class="d-none d-md-block"> MANAGEMENT
                    </h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <h2 class="fw-bold mb-3">
                        <span class="text-primary">WHAT IS TICKET</span><br>
                    ...
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <p class="mb-0 text-muted">Centralized ticket tracking</p>
                    </div>

                    <div class="d-flex align-items-start mb-3">
                        <i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>
                        <p class="mb-0 text-muted">Faster issue resolution</p>
                    </div>

                    <div class="d-flex align-items-start">
                        <i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>
                        <p class="mb-0 text-muted">Improved customer support</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-5 mb-4 mb-lg-0">
                    <h2 class="fw-bold">
                        <span class="text-primary">POWERFUL TICKET</span><br>
                        MANAGEMENT FEATURES
                    </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Easily create tickets for customer queries or internal issues with complete details.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Assign tickets to the right team members or departments for faster resolution.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Track ticket status such as Open, In Progress, Pending, or Resolved in real-time.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Set ticket priorities (High, Medium, Low) to handle urgent issues first.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Add comments, updates, and responses within tickets for clear communication.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Maintain a complete history of ticket actions and updates.</p>
                            </div>
                        </div>
        ...
        <div class="container text-center">
            ...
            <div class="row text-start text-center text-md-start">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    ...
                    <h5>Create Ticket</h5>
                    <p class="small">Submit a ticket with issue details, priority, and required information.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">02</div>
                    <h5>Assign to Team</h5>
                    <p class="small">Assign the ticket to the appropriate team or support agent.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">03</div>
                    <h5>Track & Resolve</h5>
                    <p class="small">Monitor ticket status, communicate updates, and work towards resolution.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">04</div>
                    <h5>Close & Analyze</h5>
                    <p class="small">Close resolved tickets and analyze reports to improve support performance.</p>
                </div>
