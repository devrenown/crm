            ...
            <div class="row mt-5">
                <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <h1 class="breadcrump-heading display-5 display-md-4 display-lg-3 fw-bold">
                        LEAVE <br class="d-none d-md-block"> MANAGEMENT
                    </h1>

                    <p class="fs-6 fs-md-5 mb-3">
                        Manage employee leaves, approvals, and balances effortlessly with a smart and automated system.
                    </p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <h2 class="fw-bold mb-3">
                        <span class="text-primary">WHAT IS LEAVE </span><br>
                        <span class="text-dark">MANAGEMENT SYSTEM?</span>
                    </h2>

                    <!-- Description -->
                    <p class="text-muted mb-4">
                        A Leave Management System helps businesses manage employee leave requests, approvals, and records efficiently. It simplifies the entire process, reduces manual work, and ensures transparency across the organization.  It simplifies the entire process, reduces manual work, and ensures transparency across the organization.
                    </p>

                    <!-- Features -->
                    <div class="d-flex align-items-start mb-3">
                        <i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>
                        <p class="mb-0 text-muted">Easy leave application & approval</p>
                    </div>

                    <div class="d-flex align-items-start mb-3">
                        <i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>
                        <p class="mb-0 text-muted">Real-time leave tracking</p>
                    </div>

                    <div class="d-flex align-items-start">
                        <i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>
                        <p class="mb-0 text-muted">Organized leave records</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-5 mb-4 mb-lg-0">
                    <h2 class="fw-bold">
                        <span class="text-primary">POWERFUL LEAVE</span><br>
                        MANAGEMENT FEATURES
                    </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Employees can easily apply for leaves by selecting dates, leave types, and reasons.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Managers can review, approve, or reject leave requests with a structured approval system.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Track available leave balances and usage for each employee in real-time.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Define multiple leave types such as sick leave, casual leave, paid leave, etc.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Sync leave management with company holidays for better planning.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                                ...
                                <p class="text-muted small">Maintain complete records of past leave requests and approvals.</p>
                            </div>
                        </div>
        ...
        <div class="container text-center">
            ...
            <div class="row text-start text-center text-md-start">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    ...
                    <p class="small">Employees submit leave requests by selecting dates, leave type, and reason in just a few clicks.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">02</div>
                    <h5>Review & Approve</h5>
                    <p class="small">Managers review requests and approve or reject them based on availability and policies.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">03</div>
                    <h5>Track Leave Status</h5>
                    <p class="small">Employees and managers can track leave status and balances in real-time.</p>
                </div>

                <div class="col-12 col-md-6 col-lg-3 mb-4">
                    <div class="bg-white text-dark p-3 rounded-4 d-inline-block mb-3">04</div>
                    <h5>Maintain Records</h5>
                    <p class="small">All leave data is stored securely for future reference and reporting.</p>
                </div>
