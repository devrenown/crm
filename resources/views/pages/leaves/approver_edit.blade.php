        ...
        @if($canApprove)
            <form method="POST" action="{{ route('leaves.approve', $leave) }}">
                ...
                @if($isL1ApprovalStage)
                    ...
                    @else
                        <textarea name="approved_level_1_remark" class="form-control mb-3" placeholder="L1 Remark"></textarea>
                    @endif
                @endif
                ...
                @if($isL2ApprovalStage)
                    ...
                    @else
                        <textarea name="approved_level_2_remark" class="form-control mb-3" placeholder="L2 Remark"></textarea>
                    @endif
                @endif
