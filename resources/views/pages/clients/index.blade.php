            ...
            <x-slot name="right">
                <div class="col-auto float-end ms-auto">
                    ...
                    <div class="view-icons">
                        <a href="{{ route('clients.index') }}" class="grid-view btn btn-link active"><i
                                class="fa fa-th"></i></a>
                ...
                @foreach ($clients as $client)
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <div class="dropdown profile-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)"
                                        data-url="{{ route('clients.edit', ['client' => \Crypt::encrypt($client->id)]) }}"
                                    ...
                                    <a class="dropdown-item deleteBtn" data-route="{{ route('clients.destroy', $client->id) }}"
                            ...
                            <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{ $showRoute }}">{{ $client->fullname }}</a>
                            </h4>
