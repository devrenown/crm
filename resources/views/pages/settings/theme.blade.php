                ...
                <x-form.input-block class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="img-thumbnail float-end"><img id="logo_light"
                                src="{{ !empty($settings->logo_light) ? asset('storage/' . $settings->logo_light) : asset('images/logo2.png') }}"
                ...
                <x-form.input-block class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="img-thumbnail float-end"><img id="logo_dark"
                                src="{{ !empty($settings->logo_dark) ? asset('storage/' . $settings->logo_dark) : asset('images/logo2.png') }}"
                                alt="logo light" width="40" height="40"></div>
                    </div>
                </x-form.input-block>
            </div>
                ...
                <x-form.input-block class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="img-thumbnail float-end">
                            <img id="favicon"
                                src="{{ !empty($settings->favicon) ? asset('storage/' . $settings->favicon) : asset('images/logo2.png') }}"
