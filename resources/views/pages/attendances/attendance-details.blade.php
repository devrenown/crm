                ...
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        <small class="text-muted">
                            {{ tz($attendance->startDate, 'd M Y') }}
                        </small>
                    </h5>

                    @if (!empty($attendance->created_at))
                        <div class="punch-det">
                            <h6>{{ __('First Punched In At') }}</h6>
                            <p>
                                {{ tz($attendance->created_at, 'd M Y h:i A') }}
                            </p>
                        </div>
                    @endif
                    ...
                    <div class="punch-info">
                        <div class="punch-hours">
                            <span>
                                {{ $totalHours }}
                                {{ \Str::plural(__('Hour'), intval($totalHours)) }}
                            </span>
                        </div>
                    </div>
                    ...
                    @if (!empty($attendance->updated_at))
                        <div class="punch-det">
                            ...
                            <p>
                                {{ tz($attendance->updated_at, 'd M Y h:i A') }}
                            </p>
                        </div>
                    @endif
