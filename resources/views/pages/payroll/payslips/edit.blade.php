        ...
        <div class="row">
            ...
            <div class="col">
                <div class="status-toggle">
                    ...
                    <input type="checkbox" class="form-control check" type="checkbox" id="use_allowance" name="use_allowance" {{ $payslip->use_allowance == 1 ? 'checked':'' }}>
            ...
            <div class="col">
                <div class="status-toggle">
                    ...
                    <input class="form-control check" type="checkbox" id="use_deductions" name="use_deductions" {{ $payslip->use_deduction == 1 ? 'checked':'' }}>
