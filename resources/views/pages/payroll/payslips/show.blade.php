                            ...
                            <div class="col-sm-6 m-b-20">
                                <img src="{{ appLogo() }}" class="inv-logo" alt="Logo">
                                 <ul class="list-unstyled">
                                    <li>{{ @$employee->user->companyDetail->name }}</li>
                            ...
                            <div class="col-sm-6 m-b-20">
                                <div class="invoice-details">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>{{ __('Salary Month') }}: <span>{{ date('F Y', strtotime($payslip->payslip_date)) }}</span></li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12 m-b-20">
                                <ul class="list-unstyled">
                                    ...
                                    <li>{{ __('Joining Date') }}: {{ date('d-M-Y', strtotime($employee->date_joined) ) }}</li>
                                    <li>{{ $employee->phoneNumber }}</li>
                                    <li><a href="@activeCan('show-Employeeprofile') {{ route('employees.show',['employee' => \Crypt::encrypt($employee->user->id)]) }} @else # @endactiveCan">{{ $employee->user->email }}</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="row">
