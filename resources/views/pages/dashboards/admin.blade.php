            ...
            <div class="card-body" style="max-height: 25rem; overflow-y: scroll;">
                ...
                <div class="leave-info-box">
                    <div class="media d-flex align-items-center">
                        <a @activeCan('show-Employeeprofile') href="{{ route('employees.index') }}" @else href="#" @endactiveCan class="avatar"><img src="{{ !empty($user->avatar) ? asset('storage/users/'.$user->avatar) : asset('images/user.jpg') }}" alt="{{ __('Image') }}"></a>
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        ...
                        <td class="position-relative">
                            <span class="user-img">
                                <img src="{{ !empty($user->avatar) ? asset('storage/users/'.$user->avatar) : asset('images/user.jpg') }}" alt="{{ __('Image') }}" class="avatar">
