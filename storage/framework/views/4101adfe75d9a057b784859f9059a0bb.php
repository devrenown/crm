<?php if (\Illuminate\Support\Facades\Blade::check('activeAnyCan', ['edit-designation', 'delete-designation'])): ?>
...
<?php $component->withAttributes([]); ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('activeCan', 'edit-designation')): ?>
            <a class="dropdown-item" href="javascript:void(0)" data-url="<?php echo e(route('designations.edit', $id)); ?>"
                data-ajax-modal="true" data-title="<?php echo e(__('Edit Designation')); ?>" data-size="md"><i
                    class="fa-solid fa-pencil m-r-5"></i>
                <?php echo e(__('Edit')); ?>

            </a>
        <?php endif; ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('activeCan', 'delete-designation')): ?>
            <a class="dropdown-item deleteBtn" data-route="<?php echo e(route('designations.destroy', $id)); ?>"
                data-title="<?php echo e(__('Delete Designation')); ?>" data-question="<?php echo e(__('Are you sure you want to delete?')); ?>"
...
<?php endif; ?><?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/designations/actions.blade.php ENDPATH**/ ?>