             ...
             <?php $__env->slot('right', null, []); ?> 
                <div class="col-auto float-end ms-auto">
                    ...
                    <div class="view-icons">
                        <a href="<?php echo e(route('holidays.index')); ?>" data-bs-toggle="tooltip" data-bs-title="<?php echo e(__("Holidays List")); ?>" class="list-view btn btn-link active"><i class="fa-solid fa-bars"></i></a>
                        <a href="<?php echo e(route('holidays.calendar')); ?>" data-bs-toggle="tooltip" data-bs-title="<?php echo e(__("Holidays Calendar")); ?>" class="grid-view btn btn-link"><i class="fa fa-calendar"></i></a>
                    </div>
                </div>
             <?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/holidays/index.blade.php ENDPATH**/ ?>