      ...
      <div class="col-lg-10">
        <div class="card shadow-sm border-0 rounded-4">
          <div class="card-body p-4 p-md-5">
            ...
            <p class="text-muted text-center mb-5">Last updated: <?php echo e(date('F d, Y')); ?></p>
            ...
            <div class="text-center mt-3">
              <a href="<?php echo e(url('/')); ?>" class="btn btn-primary px-4 rounded-pill">Back to Home</a>
            </div>
...
<?php echo $__env->make(FRONT_LAYOUT_PATH, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/front/blocks/term_&_condition.blade.php ENDPATH**/ ?>