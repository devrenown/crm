<?php if (\Illuminate\Support\Facades\Blade::check('activeAnyCan', ['edit-holiday', 'delete-holiday'])): ?>
...
<?php $component->withAttributes([]); ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('activeCan', 'edit-holiday')): ?>
        <a class="dropdown-item" href="javascript:void(0)" data-url="<?php echo e(route('holidays.edit', $id)); ?>"
            data-ajax-modal="true" data-title="<?php echo e(__('Edit Holiday')); ?>" data-bs-toggle="tooltip"
            data-bs-title="<?php echo e(__('Edit Holiday')); ?>" data-size="lg">
            <i class="fa-solid fa-pencil m-r-5"></i>
            <?php echo e(__('Edit')); ?>

        </a>
        <?php endif; ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('activeCan', 'delete-holiday')): ?>
        <a class="dropdown-item deleteBtn" data-route="<?php echo e(route('holidays.destroy', $id)); ?>"
            data-title="<?php echo e(__('Delete Holiday')); ?>" data-question="<?php echo e(__('Are you sure you want to delete?')); ?>"
...
<?php endif; ?><?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/holidays/actions.blade.php ENDPATH**/ ?>