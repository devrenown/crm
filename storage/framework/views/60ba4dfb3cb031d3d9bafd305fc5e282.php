<div class="modal-body">
    <form action="<?php echo e(route('shift.add-remove-employee')); ?>" method="post">
        <?php echo csrf_field(); ?>

        <input type="hidden" value="<?php echo e($shift->id); ?>" name="shift_id">
        <div class="row">
...
<?php endif; ?>
                    ...
                    <select name="shift" class="form-control" required>
                        <option value="<?php echo e($shift->id); ?>" selected><?php echo e($shift->name); ?></option>
                    </select>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(__('Add/Remove Employees')); ?>
...
<?php endif; ?>
                    ...
                    ?>
                    <select name="employee[]" class="form-control select" data-placeholder="<?php echo e(__('Add/Remove Employees')); ?>" multiple required>
                        <?php if(!empty($employees)): ?>
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($employee->id); ?>" <?php echo e(in_array($employee->id, $employeesShiftIds) ? 'selected' : ''); ?>><?php echo e($employee->fullname); ?></option>
...
<?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/shift/employee-add-remove.blade.php ENDPATH**/ ?>