<div class="modal-body">
    <form action="<?php echo e(route('designations.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input','data' => ['type' => 'text','name' => 'name','placeholder' => ''.e(__('Enter Designation')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'name','placeholder' => ''.e(__('Enter Designation')).'']); ?>
...
<?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/pages/designations/create.blade.php ENDPATH**/ ?>