...
<div class="wrapper">
    ...
    <!-- HEADER -->
    <div class="header">
        <h1>Happy Birthday <?php echo e($user->firstname); ?>!</h1>
        <img
            src="<?php echo e($user->avatar ? asset('storage/users/'.$user->avatar) : asset('images/default-avatar.png')); ?>"
    ...
    <div class="content">
        <p>
            Dear <strong><?php echo e($user->fullname); ?></strong>,
        </p>
    ...
    <div class="footer">
        Warm wishes,<br>
        <strong>Team <?php echo e($tenant->name); ?></strong>
    </div>
...
<?php /**PATH /home/renown/public_html/renownsystem.com/resources/views/mail/birthday.blade.php ENDPATH**/ ?>